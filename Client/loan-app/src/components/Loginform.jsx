...
const EmailOtpLogin = () => {
  ...
  const sendOtp = async () => {
    try {
      const res = await axios.post('https://b43-web-172-web-project-167-2.onrender.com/api/send-email-otp', {
        email,
      });
  ...
  const verifyOtp = async () => {
    ...
    try {
      const res = await axios.post('https://b43-web-172-web-project-167-2.onrender.com/api/verify-email-otp', {
        email,
        otp,
      });
      setMessage(res.data.message);
